...
@customElement('tap-options')
@adoptedStyle(style)
@adoptedStyle(focusStyle)
@shadow()
@aria({ focusable: true, role: 'listbox' })
export class TapOptionsElement extends GemElement {
          ...
          return label === SEPARATOR
            ...
            : html`
                <div
                  ...
                  @keydown=${commonHandle}
                >
                  <tap-use v-if=${!!icon} class="icon" .element=${icon}></tap-use>
                  <div class="value">
                    <div class="label">${label}</div>
                    <div class="description">${description}</div>
                  </div>
                  <div v-if=${!!tag} class="tag">${tag}</div>
                  <tap-use v-if=${!!tagIcon} class="icon" .element=${tagIcon}></tap-use>
                  <tap-use
                    v-if=${!!onRemove}
                    class="icon action"
