...
export type ResizeDetail = {
  contentRect: TapResizeBaseElement['contentRect'];
  borderBoxSize: TapResizeBaseElement['borderBoxSize'];
};

export function resizeObserver(ele: TapResizeBaseElement) {
...
export class TapResizeBaseElement extends GemElement {
