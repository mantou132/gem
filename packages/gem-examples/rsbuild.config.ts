  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        '@mantou/tap-ui/elements': path.resolve(__dirname, '../tap-ui/src/elements'),
        '@mantou/tap-ui/patterns': path.resolve(__dirname, '../tap-ui/src/patterns'),
        '@mantou/tap-ui/lib': path.resolve(__dirname, '../tap-ui/src/lib'),
        '@mantou/tap-ui/helper': path.resolve(__dirname, '../tap-ui/src/helper'),
      },
    },
    plugins: [
      {
